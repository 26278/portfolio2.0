...
@section('main')
    <div class="container">
        <div class="left">
            ...
            <p class="subtitle desktop" style="opacity: 0">een <span>Fullstack Developer</span> in opleiding.</p>
            <p class="subtitle mobile" style="opacity: 0"><span>Fullstack Developer </span><br>in opleiding.</p>
